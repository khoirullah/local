...
$PAGE->set_url(new moodle_url('/local/company/suspend.php'));
...
$form = new \local_user_management\form\suspend_userid_form(null,['userid' => $userid]);
...
if ($data = $form->get_data()) {
    ...
    $count = $suspender->suspend_users([$data->userid]);
